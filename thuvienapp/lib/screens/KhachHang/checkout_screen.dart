...
class CheckoutScreen extends StatefulWidget {
  ...
  const CheckoutScreen(
      {super.key, required this.cartItems, required this.user});
...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  void _datHang() async {
    if (_addressController.text.trim().isEmpty ||
      ...
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
          content:
              Text('Vui lòng nhập đầy đủ địa chỉ và số điện thoại giao hàng'),
    ...
    try {
      final requestBody = {
        "maKH": widget.user
            .realId, // Lấy ID của Khách Hàng (realId map với Makh trong backend)
        "tenNguoiNhan": widget
            .user.fullName, // Hoặc lấy từ 1 controller nếu cho phép đổi tên
        ...
        showDialog(
            ...
            builder: (ctx) => AlertDialog(
                  ...
                  content: Column(mainAxisSize: MainAxisSize.min, children: [
                    ...
                    Text('Tổng thanh toán: ${_fmt(_totalPrice)} đ',
                        style: TextStyle(
                            color: primaryBlue,
                            fontWeight: FontWeight.bold,
                            fontSize: 16)),
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            ...
                            Navigator.of(context).popUntil(
                                (route) => route.isFirst); // Về trang chủ
                          },
          ...
          Container(
              ...
              child: Column(
                  ...
                  children: [
                    ...
                    _field('Số điện thoại', 'Chưa có số điện thoại',
                        controller: _phoneController,
                        keyboardType: TextInputType.phone),
                    _field('Địa chỉ giao hàng', 'Chưa có địa chỉ',
                        controller: _addressController),
                    _field('Ghi chú', 'Ghi chú cho đơn hàng...',
              ...
              child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: _isProcessing
                        ...
                        : Text('Đặt hàng  •  ${_fmt(_totalPrice)} đ',
                            style: const TextStyle(
  ...
  Widget _field(String label, String hint,
    ...
    return Padding(
        ...
        child: TextField(
          controller:
              controller ?? TextEditingController(text: enabled ? null : hint),
          enabled: enabled,
          keyboardType: keyboardType,
          maxLines: maxLines,
          style: TextStyle(
              fontSize: 14, color: enabled ? Colors.black87 : Colors.grey[700]),
  ...
  Widget _priceRow(String label, double amount) {
    return Padding(
        ...
        child:
          ...
          Text(amount == 0 ? 'Miễn phí' : '${_fmt(amount)} đ',
              style: TextStyle(
